...
//var FarmerRole = articfacts.require('FarmerRole')
...
contract('SupplyChain', function(accounts) {
    ...
    var sku = 1
    var upc = 1
    const ownerID = emptyAddress;
    const originFarmerID = accounts[1]
    const originFarmName = "John Doe"
    const originFarmInformation = "Yarray Valley"
    const originFarmLatitude = "-38.239770"
    const originFarmLongitude = "144.341490"
    var productID = 'P'+sku + '-' + upc
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        //const farmers = await FarmerRole({from:originFarmerID});
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        supplyChain.Processed({},
            (err, res) => {
                eventEmitted = true
                //console.log("2. Event should be emitted processed called");
            });
        //console.log("1. start processItem");

        // Mark an item as Processed by calling function processtItem()
        await supplyChain.processItem(upc, {from:originFarmerID});
        //console.log("3. done processItem");
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        supplyChain.Packed({},
            (err, res) => {
                eventEmitted = true
                //console.log("2. Event should be emitted packed called");
            });
        //console.log("1. start packItem");        

        // Mark an item as Packed by calling function packItem()
        await supplyChain.packItem(upc, {from:originFarmerID});
        //console.log("3. done packItem");        
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        supplyChain.ForSale({},
            (err, res) => {
                eventEmitted = true
                //console.log("2. Event should be emitted ForSale called");
            });
        //console.log("1. start ForSale");        
        

        // Mark an item as ForSale by calling function sellItem()
        await supplyChain.sellItem(upc, productPrice, {from:originFarmerID});
        //console.log("3. done ForSale");         
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        //console.log("1. start Sold");        
        await supplyChain.buyItem(upc, {from:distributorID, value: web3.utils.toWei("1.5", "ether"), gas:0});
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[3], productNotes, 'Error: Invalid distributorID')
        assert.equal(resultBufferTwo[4], productPrice, 'Error: Invalid item price')        
        assert.equal(resultBufferTwo[5], 7, 'Error: Invalid item State')        
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Invalid distributorID')
