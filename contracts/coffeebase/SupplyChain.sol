...
contract SupplyChain {
    ...
    function harvestItem(
        ...
        string memory prodId = string(abi.encodePacked("P1-1"));
        //TODO: need to add function for conversion ??
        items[_upc] = Item({
            ...
            productID: prodId, // Product ID potentially a combination of upc + sku
